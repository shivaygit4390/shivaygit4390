...
<h3 align="center">
💼 <strong>Software Engineer</strong> with <strong>1.5+ years</strong> of professional experience
</h3>

<p align="center">
Currently working at <strong>Impakable Solutions</strong>, designing, building, and maintaining production-ready web applications for real clients.
</p>

<p align="center">
I specialize in developing <strong>scalable, secure, and maintainable full-stack applications</strong>, with hands-on ownership across frontend development, backend engineering, API integrations, deployment, and production support.
</p>
...
On the frontend, I build responsive and maintainable user interfaces using **React.js** and **Tailwind CSS**.

On the backend, I develop **REST APIs** and production-ready systems using **Node.js**, **Express.js**, and **PostgreSQL (Supabase)**, implementing authentication, role-based access control, secure document management, payment workflows, and third-party integrations.

I take ownership of projects **end to end**, from requirement analysis and development to deployment, production support, and continuous feature enhancements. My experience includes building authentication systems, payment integrations, AI-powered features, approval and referral workflows, and solving real-world production challenges.
...
<img src="https://img.shields.io/badge/RLS-181818?style=for-the-badge"/>
...
My goal is to continuously strengthen my expertise in full-stack development, backend engineering, system design, and scalable software architecture while delivering impactful products.
...
- 🌐 **Portfolio:** https://nirmalsingh.netlify.app
- 📧 **Email:** nirmalsingh9838797128@gmail.com
